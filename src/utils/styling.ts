import { InChatTheme, AccentOption, FontOption, SponsoredSuggestionsTheme } from '../types';
import { 
  getColorTheme, 
  getFontStyles, 
  getSolidBackground,
...
export const createSponsoredSuggestionsCSS = (theme: SponsoredSuggestionsTheme = {}) => {
  // Backward compatibility: prefer 'mode' over 'theme', but support both
  const themeMode = theme.mode ?? (theme as any).theme ?? 'light';
  const {
    accent = 'blue',
  ...
  return `
    ...
    .simula-sponsored-suggestion-slot {
      width: 100%;
      height: 100%;
      margin: 0px;
      line-height: 1.5;
    ...
    .simula-sponsored-suggestion-frame {
      width: 100%;
      height: 100%;
      border: none;
      outline: none;
    ...
    .simula-sponsored-suggestions .simula-info-icon {
      position: absolute;
      top: 12px;
      right: 12px;
      background: none;
    ...
    .simula-sponsored-suggestions .simula-info-icon:hover {
      opacity: 1;
      transform: scale(1.1);
    }

    .simula-sponsored-suggestions .simula-modal-overlay {
      position: absolute;
      top: 0;
      left: 0;
      right: 0;
    ...
    .simula-sponsored-suggestions .simula-modal-content {
      background: ${getSolidBackground(colors)};
      border-radius: ${cornerRadius}px;
      padding: 16px;
      width: 75%;
    ...
    .simula-sponsored-suggestions .simula-modal-close {
      position: absolute;
      top: 8px;
      right: 12px;
      background: none;
    ...
    .simula-sponsored-suggestions .simula-modal-close:hover {
      color: ${colors.text};
    }

    .simula-sponsored-suggestions .simula-modal-link {
      color: ${colors.primary};
      text-decoration: underline;
    }

    .simula-sponsored-suggestions .simula-modal-link:hover {
      color: ${colors.primaryHover};
      text-decoration: underline;
    }
  `;
